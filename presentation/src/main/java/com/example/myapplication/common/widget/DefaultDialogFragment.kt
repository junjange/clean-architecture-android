package com.example.myapplication.common.widget
...
import com.example.myapplication.common.base.BaseDialogFragment
import com.example.myapplication.common.util.setOnSingleClickListener
...
class DefaultDialogFragment : BaseDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        contents?.let { contentsLayout.addView(it) }
